            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/special-need/' . $specialneed->id . '/edit') }}" title="Edit SpecialNeed"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

                        <form method="POST" action="{{ url('specialneed' . '/' . $specialneed->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    <tr>
                                        <th>ID</th><td>{{ $specialneed->id }}</td>
                                    </tr>
                                    <tr><th> Descrição </th><td> {{ $specialneed->descrição }} </td></tr>
                                </tbody>
                            </table>
                        </div>
