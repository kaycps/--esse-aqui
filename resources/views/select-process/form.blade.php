<div class="form-group {{ $errors->has('dataInicio') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="dataInicio" type="date" id="dataInicio" value="{{ $selectprocess->dataInicio or ''}}" required>
...
<div class="form-group {{ $errors->has('dataFim') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="dataFim" type="date" id="dataFim" value="{{ $selectprocess->dataFim or ''}}" required>
...
<div class="form-group {{ $errors->has('nome') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="nome" type="text" id="nome" value="{{ $selectprocess->nome or ''}}" required>
...
<div class="form-group {{ $errors->has('descrição') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="descrição" type="text" id="descrição" value="{{ $selectprocess->descrição or ''}}" required>
